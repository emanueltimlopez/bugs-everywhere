...
export default class BootScene extends Phaser.Scene {
  ...
  init () {
    ...
    sheet.insertRule('@font-face { font-family: "8bitMadness"; src: url("src/assets/fonts/8bitmadness.ttf"); }\n', 0);
    sheet.insertRule('@font-face { font-family: "Stencil8bit"; src: url("src/assets/fonts/stencil8bit.ttf"); }\n', 0);
  }

  preload() {
    this.load.image('loading', 'src/assets/loading.jpg');
    //this.load.image('player', 'src/assets/submarine.png');
